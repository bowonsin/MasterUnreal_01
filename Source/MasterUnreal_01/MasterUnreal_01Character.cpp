...
AMasterUnreal_01Character::AMasterUnreal_01Character()
{
...
void AMasterUnreal_01Character::NotifyControllerChanged()
{
...
void AMasterUnreal_01Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMasterUnreal_01Character::Move);
...
void AMasterUnreal_01Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
